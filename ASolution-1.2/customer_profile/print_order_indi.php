...
/* ENd CSS for counting */
    ...
    <body>
        ...
        $sql = $con->prepare("Select"
                ...
                . " where tbl_order.cust_id='$cust_id_get' ");
        $sql->execute();
...
<div class="container">
  <div class="row">
   ...
   <tr style="border-bottom: none;  ">
      ...
      <th colspan="6">
         <h2>Advertisement Department</h2><span>All Orders of:</span><br>
             <?php
            $cust_query=$con->prepare("select tbl_customer.cust_id_new,tbl_customer.name,state.statename from tbl_customer "
                . " inner join country on tbl_customer.division=country.id"
                . " inner join state on tbl_customer.district=state.id "
                    . " where tbl_customer.cust_id='$cust_id_get' ");
            $cust_query->execute();
            while ($row_cust=$cust_query->fetch(PDO::FETCH_ASSOC)){
                echo ' Client name: '.$row_cust['name'].'<br>Client Id: '.$row_cust['cust_id_new'].', District: '.$row_cust['statename'];
            }
            ?>
        </th>
    </tr>
   ...
   <tr style="border-top: none; border-bottom: none; ">
    <th colspan="3" style="border-top: none; border-bottom: none; text-align: left; padding:2px 3px;  " >Phone: +88 02 9145606, +88 02 9145608</th>
    ...
    <th colspan="3" rowspan="2" style="border-top: none; text-align: left; padding:2px 3px; vertical-align: top; ">Email: advt@asianage.com</th>
   ...
   <tr style="border-top:1px solid red;">
    ...
    <tr>
    <th colspan="7" style="background: #f1f2f3; font-size:14px; font-style: italic;">
Order Report for Individual Client
     </th>
   ...
   <tr>
    ...
    <tr>
      <th colspan="4">Monthly / Individual Report</th>
