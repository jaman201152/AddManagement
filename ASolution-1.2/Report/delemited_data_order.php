<?php
    ...
    if (isset($_GET['today'])) {
        $today = $_GET['today'];
       // $today;
        $where = " where tbl_order.order_date like '$today%' ";
...
//if($voucher_type==='Payment Voucher'){ $voucher_type1 = "Purchase";}else{$voucher_type1="Salse ";}
 echo $sep." Report of all Orders date from: ".$today." to ".$today."\n\n";
    }
       ...
       // $fromWeekDatef.$toWeekDatef;
        $where = " where tbl_order.order_date between '$fromWeekDatef' and '$toWeekDatef' ";  
        echo $sep.$sep."The Asian Age".$sep."\n".$sep.$sep."Sr Tower, Tejgaon, Dhaka-1215.".$sep.$sep."\n".$sep.$sep."\n";
//if($voucher_type==='Payment Voucher'){ $voucher_type1 = "Purchase";}else{$voucher_type1="Salse ";}
 echo $sep." Report of all Orders date from: ".$fromWeekDate." to ".$toWeekDatef."\n\n";
    }
       ...
       // $fromWeekDatef.$toWeekDatef;
           $where = "where tbl_order.order_date between '$fromlastWeekDatef' and '$tolastWeekDatef' ";  
           echo $sep.$sep."The Asian Age".$sep."\n".$sep.$sep."Sr Tower, Tejgaon, Dhaka-1215.".$sep.$sep."\n".$sep.$sep."\n";
//if($voucher_type==='Payment Voucher'){ $voucher_type1 = "Purchase";}else{$voucher_type1="Salse ";}
 echo $sep." Report of all Orders date from: ".$fromlastWeekDatef." to ".$tolastWeekDatef."\n\n";
    }
    ...
    if(isset($_GET['firstDayOfMonth']) && isset($_GET['lastDayOfMonth'])){
       ...
       //  $firstDayOfMonth.$lastDayOfMonth;
        $where = " where tbl_order.order_date between '$firstDayOfMonth' and '$lastDayOfMonth' "; 
        echo $sep.$sep."The Asian Age".$sep."\n".$sep.$sep."Sr Tower, Tejgaon, Dhaka-1215.".$sep.$sep."\n".$sep.$sep."\n";
//if($voucher_type==='Payment Voucher'){ $voucher_type1 = "Purchase";}else{$voucher_type1="Salse ";}
 echo $sep." Report of all Orders date from: ".$firstDayOfMonth." to ".$lastDayOfMonth."\n\n";
    }
       ...
       //  $firstDayOfMonth.$lastDayOfMonth;
        $where = " where tbl_order.order_date between '$first_day_pre_month' and '$last_day_pre_month' ";         
        echo $sep.$sep."The Asian Age".$sep."\n".$sep.$sep."Sr Tower, Tejgaon, Dhaka-1215.".$sep.$sep."\n".$sep.$sep."\n";
 echo $sep." Report of all Orders date from: ".$sep.$first_day_pre_month.$sep." to ".$sep.$last_day_pre_month.$sep."\n\n";
    }
    if(isset($_GET['all'])){
        $all = $_GET['all'];
       // "all time period.";
       $where = " ";
    echo $sep." Report of all Orders date for all time period.".$sep." \n\n";
    }
        $query = $con->prepare("Select tbl_order.order_id,tbl_order.cust_id_new,tbl_order.order_date,tbl_order.price,"
                . "tbl_order.discount_amount,tbl_order.payable_amount,tbl_customer.name  from tbl_order"
...
$filename = "order_".$date_excel;      //File Name
...
$rs = $con->query('SELECT tbl_order.order_id,tbl_order.cust_id_new,tbl_order.order_date,tbl_order.price,tbl_order.discount_amount,'
        . 'tbl_order.payable_amount,tbl_customer.name FROM tbl_order'
             . " inner join tbl_customer on tbl_order.cust_id=tbl_customer.cust_id "
        . ' LIMIT 0');
